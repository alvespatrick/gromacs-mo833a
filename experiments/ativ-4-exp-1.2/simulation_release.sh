/usr/lib/linux-tools/5.4.0-109-generic/perf ../../build/bin/gmx mdrun -v -deffnm em
...
sudo /usr/lib/linux-tools/5.4.0-109-generic/perf record -g ../../build/bin/gmx mdrun -v -deffnm em
sudo /usr/lib/linux-tools/5.4.0-109-generic/perf report

#sudo /usr/lib/linux-tools/5.4.0-109-generic/valgrind --leak-check=yes ../../build/bin/gmx mdrun -v -deffnm em


#sudo /usr/lib/linux-tools/5.4.0-109-generic/perf record --call-graph=dwarf -g  ../../build/bin/gmx mdrun -v -deffnm em
#sudo /usr/lib/linux-tools/5.4.0-109-generic/perf report --hierarchy -M intelD
